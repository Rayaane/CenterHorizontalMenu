 ...
 */
class MenuLayoutManager(context: Context?, var onItemSelected: MenuItemSelected , var focusCenter : Boolean) : LinearLayoutManager(context) {
    ...
    override fun onScrollStateChanged(state: Int) {
        ...
        if (state.equals(RecyclerView.SCROLL_STATE_IDLE)) {
            ...
            onItemSelected.menuItemSelected(position)
        }
    }
